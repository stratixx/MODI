...
tkonc = 69;
Tp=1;
U_vector = [ -0.8 -0.5 -0.2 ];

shift = 100;
tkonc = tkonc+shift;
stepTime = 10+shift;

step_matrix = [ stepTime -1 -0.8;...
                stepTime -1 -0.5; ...
                stepTime -1 -0.2; ...
                stepTime U_vector(1)-0.2 U_vector(1)+0.2;...
                stepTime U_vector(2)-0.2 U_vector(2)+0.2;...
                stepTime U_vector(3)-0.2 U_vector(3)+0.2;
                ];
